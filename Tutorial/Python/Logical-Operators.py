...
if age > 25 or salary >= 30000:  # using and both variables must be correct otherwise else statement will be excutated
...
'''
# same example above but using if and else instead of adding logical operator
if age > 25:
   print("You are eligible for an age loan")
else:
    print("You are not eligible for an age loan.")

if salary == 50000:
   print("You are eligible for a salary loan")
else:
    print("You are not eligible for a salary loan.")
'''
